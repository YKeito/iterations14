...
####FDR005####
#up
CY15_1h_FDR005_up <- sum(common_network$CY15_1h_FDR005_color == "U")
CY15_3h_FDR005_up <- sum(common_network$CY15_3h_FDR005_color == "U")
CY15_12h_FDR005_up <- sum(common_network$CY15_12h_FDR005_color == "U")
CY15_24h_FDR005_up <- sum(common_network$CY15_24h_FDR005_color == "U")
CY15_48h_FDR005_up <- sum(common_network$CY15_48h_FDR005_color == "U")
CY16_1h_FDR005_up <- sum(common_network$CY16_1h_FDR005_color == "U")
CY16_3h_FDR005_up <- sum(common_network$CY16_3h_FDR005_color == "U")
CY16_12h_FDR005_up <- sum(common_network$CY16_12h_FDR005_color == "U")
CY16_24h_FDR005_up <- sum(common_network$CY16_24h_FDR005_color == "U")
CY16_48h_FDR005_up <- sum(common_network$CY16_48h_FDR005_color == "U")
CY20_1h_FDR005_up <- sum(common_network$CY20_1h_FDR005_color == "U")
CY20_3h_FDR005_up <- sum(common_network$CY20_3h_FDR005_color == "U")
CY20_12h_FDR005_up <- sum(common_network$CY20_12h_FDR005_color == "U")
CY20_24h_FDR005_up <- sum(common_network$CY20_24h_FDR005_color == "U")
CY20_48h_FDR005_up <- sum(common_network$CY20_48h_FDR005_color == "U")
#down
CY15_1h_FDR005_down <- sum(common_network$CY15_1h_FDR005_color == "D")
CY15_3h_FDR005_down <- sum(common_network$CY15_3h_FDR005_color == "D")
CY15_12h_FDR005_down <- sum(common_network$CY15_12h_FDR005_color == "D")
CY15_24h_FDR005_down <- sum(common_network$CY15_24h_FDR005_color == "D")
CY15_48h_FDR005_down <- sum(common_network$CY15_48h_FDR005_color == "D")
CY16_1h_FDR005_down <- sum(common_network$CY16_1h_FDR005_color == "D")
CY16_3h_FDR005_down <- sum(common_network$CY16_3h_FDR005_color == "D")
CY16_12h_FDR005_down <- sum(common_network$CY16_12h_FDR005_color == "D")
CY16_24h_FDR005_down <- sum(common_network$CY16_24h_FDR005_color == "D")
CY16_48h_FDR005_down <- sum(common_network$CY16_48h_FDR005_color == "D")
CY20_1h_FDR005_down <- sum(common_network$CY20_1h_FDR005_color == "D")
CY20_3h_FDR005_down <- sum(common_network$CY20_3h_FDR005_color == "D")
CY20_12h_FDR005_down <- sum(common_network$CY20_12h_FDR005_color == "D")
CY20_24h_FDR005_down <- sum(common_network$CY20_24h_FDR005_color == "D")
CY20_48h_FDR005_down <- sum(common_network$CY20_48h_FDR005_color == "D")

#CY15
df <- data.frame(expression_change = rep(c("01up", "02down"), times = 5),
...
g <- g + labs(title = "CY15 DEGs ( q < 0.05 )")
g <- g + theme(axis.text=element_text(size=20), axis.title=element_text(size=20,face="bold"))
CY15 <- g + theme_bw(base_size = 20)

plot(CY15)
#CY16
df <- data.frame(expression_change = rep(c("01up", "02down"), times = 5),
                 Numgenes = c(CY16_1h_FDR005_up, CY16_1h_FDR005_down,
...
g <- g + ylab("Number of DEGs")
g <- g + xlab("time-course")
g <- g + labs(title = "CY16 DEGs ( q < 0.05 )")
g <- g + theme(axis.text=element_text(size=20), axis.title=element_text(size=20,face="bold"))
CY16 <- g + theme_bw(base_size = 20)

plot(CY16)

#CY20
df <- data.frame(expression_change = rep(c("01up", "02down"), times = 5),
                 Numgenes = c(CY20_1h_FDR005_up, CY20_1h_FDR005_down,
...
g <- g + ylab("Number of DEGs")
g <- g + xlab("time-course")
g <- g + labs(title = "CY20 DEGs ( q < 0.05 )")
g <- g + theme(axis.text=element_text(size=20), axis.title=element_text(size=20,face="bold"))
CY20 <- g + theme_bw(base_size = 20)

plot(CY20)

library(gridExtra)
grid.arrange(CY15, CY16, CY20,
             nrow = 3)
...
#CY16
df <- data.frame(expression_change = rep(c("01up", "02down"), times = 5),
                 Numgenes = c(CY16_1h_FDR0005_up, CY16_1h_FDR0005_down,
...
#CY20
df <- data.frame(expression_change = rep(c("01up", "02down"), times = 5),
                 Numgenes = c(CY20_1h_FDR0005_up, CY20_1h_FDR0005_down,
